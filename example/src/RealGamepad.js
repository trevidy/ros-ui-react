...
class RealGamepad extends Component {
  ...
  componentDidMount() {
    ...
    this.ros.on('connection', function () {
      console.log('Connection mdfdfdade!');
    });
  ...
  timerEnd = () => {
    ...
    // DEBUG: see what controllers are actually stored
    console.log("Current controllers:", Object.keys(this.controllers));
    ...
    if (this.controllers[0]) {
      ...
      console.log("Publishing Joy Message:", JSON.stringify(joyMsg));
      this.topic.publish(new ROSLIB.Message(joyMsg));
